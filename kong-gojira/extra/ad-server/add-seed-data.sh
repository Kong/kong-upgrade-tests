...
samba-tool user create "John Nash" --uid john.nash --surname John --mail-address jnash@beautifulmind.com --userou OU=mathematicians --uid-number 88887 --uid-number 99998 --unix-home home damng00dcoffEE
samba-tool user create euclid --uid euclid --surname euclid --userou OU=mathematicians damng00dcoffEE
samba-tool user create "Nikola Tesla" --uid tesla --surname Tesla --mail-address tesla@ldap.forumsys.com --userou OU=mathematicians --uid-number 88888 --uid-number 99999 --unix-home home damng00dcoffEE
samba-tool user create einstein --surname einstein --uid einstein --userou OU=scientists damng00dcoffEE
samba-tool user create "Andrei Sakharov" --surname Andrei --uid andrei.sakharov --userou OU=scientists --mail-address asakharov@ras.ru --uid-number 88287 --gid-number 99999 --unix-home home damng00dcoffEE
